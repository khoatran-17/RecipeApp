...
var _userRecipeView = require('./userRecipeView');
...
const controlUserRecipe = () => {
  ...
  _base.elements.userRecipeForm.addEventListener('submit', _userRecipeView.submitUserRecipe);
};
...
window.addEventListener('load', () => {
  ...
  state.userRecipe.userRecipes.forEach(curr => _userRecipeView.renderUserListItem(curr));
});
/**
* RECIPE CONTROLLER
*/
...
const controlRecipe = async e => {
  ...
  if (url.includes('#recipe')) {
    ...
    _userRecipeView.displayUserRecipe(userRecipeID);
...
},{"./Search":"5MdMM","./searchView":"4vEoB","./Recipe":"6x38A","./recipeView":"604sK","./Like":"23ebU","./likeView":"5Tk5D","./base":"3mFxE","./userRecipe":"36mVm","./userRecipeView":"4EESX","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5MdMM":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
const key = 'd04f1c6a-1870-457f-9c61-1b90a53e236a';
...
const createButton = (page, type) => {
  let buttonMarkup;
  if (type === 'hidden') {
    buttonMarkup = `<button class="${_base.elementStrings.btn_inline} results__btn--hidden">
                      <span>HiddenBtn</span>
                    </button>`;
  } else {
    buttonMarkup = `<button class="${_base.elementStrings.btn_inline} results__btn--${type}" data-goto=${type === 'prev' ? page - 1 : page + 1}>
  ...
  const markup = `
            ...
            <div class="recipe__directions">
                ...
                <p class="recipe__directions-text">
                    ...
                    <span class="recipe__by">${recipe.author}</span>. Find out more details about the recipe below.
                </p>
...
},{"./base":"3mFxE","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4EESX":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
const renderUserListItem = recipe => {
  _base.elements.userList.insertAdjacentHTML('beforeend', listItemMarkup(recipe));
};
...
function submitUserRecipe(event) {
  try {
    ...
    _base.elements.allInputs.forEach(input => input.value = '');
  } catch (error) {
    window.alert(error);
  }
}
...
},{"./base":"3mFxE","./searchView":"4vEoB","./recipeView":"604sK","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["21c8X","3L8AI"], "3L8AI", "parcelRequired587")
